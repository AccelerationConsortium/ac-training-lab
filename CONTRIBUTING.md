...
If you experience bugs or general issues with `ac-training-lab`, please have a look
...
You can help improve `ac-training-lab` docs by making them more readable and coherent, or
...
5. Install [pre-commit]:
   ...
   `ac-training-lab` comes with a lot of hooks configured to automatically help the
