...
1. review and uncomment what you need in `environment.yml` and create an environment `ac-training-lab` with the help of [conda]:
   ```
...
2. Create concrete dependencies as `environment.lock.yml` for the exact reproduction of your
   environment with:
   ```bash
   conda env export -n ac-training-lab -f environment.lock.yml
   ```
